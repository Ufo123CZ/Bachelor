...
public class VdpParserConst {
    ...
    // Stat
    protected static final String ELEMENT_STATY = "vf:Staty";
    protected static final String ELEMENT_STAT = "vf:Stat";

    // Region soudrznosti
    protected static final String ELEMENT_REGIONY_SOUDRZNOSTI = "vf:RegionySoudrznosti";
