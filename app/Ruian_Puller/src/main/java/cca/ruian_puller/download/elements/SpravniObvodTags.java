...
public class SpravniObvodTags {
    public static final String ELEMENT_KOD = "spi:Kod";
    public static final String ELEMENT_NAZEV = "spi:Nazev";
    public static final String ELEMENT_NESPRAVNY = "spi:Nespravny";
    public static final String ELEMENT_SPRAVNIMOMCKOD = "spi:SpravniMomcKod";
    public static final String ELEMENT_OBEC = "spi:Obec";
