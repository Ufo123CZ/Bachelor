...
public class ObecTags {
    ...
    public static final String ELEMENT_STATUSKOD = "StatusKod";
    public static final String ELEMENT_OKRES = "Okres";
    public static final String ELEMENT_POU = "Pou";
    ...
    public static final String ELEMENT_CLENENI_SM_ROZSAH_KOD = "CleneniSMRozsahKod";
